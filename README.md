...
- **Unit Testing** - Jest unit tests with automated CI via GitHub Actions
...
You can generate a PFX certificate in Windows by using the `./scripts/generate-local-pfx.ps1` PowerShell script.
